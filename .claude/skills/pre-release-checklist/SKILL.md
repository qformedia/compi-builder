...
<!-- Mirrored from .cursor/skills/pre-release-checklist/SKILL.md — keep in sync. -->
...
**Is the test catching a real bug?** Fix the bug, not the test. Then consider: could a rule or skill have prevented this? If so, create or update one.
